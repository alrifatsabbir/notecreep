...
const API = axios.create({
  baseURL: 'https://notecreep.vercel.app/',
  headers: {
...
export const auth = {
  ...
  verifyEmailByLink: (token) => API.get(`/auth/verify-email?token=${token}`),
...
export const notes = {
  ...
  // ✅ নতুন alias, ViewNotePage.jsx এ use করবে
  ...
  // src/services/api.js এর notes object এ
